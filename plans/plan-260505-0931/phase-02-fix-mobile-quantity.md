...
- [x] **MỚI**: Sửa lỗi tương tự trong Modal Sửa đơn thuốc và Thêm thuốc tại `src/components/features/patients/PrescriptionHistory.tsx`.
- [x] **MỚI**: Thêm `overflow-x-auto` và `min-width` cho bảng trong Modal để tránh bị bóp nghẹt trên màn hình nhỏ.
...
- [x] Kiểm tra cả Modal trong PrescriptionHistory.