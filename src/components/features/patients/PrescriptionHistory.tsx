...
const MedicineAutocomplete = dynamic(() => import('../prescriptions/MedicineAutocomplete'), { ssr: false });
...
const MedicineUsageDialog = dynamic(() => import('./MedicineUsageDialog'), { ssr: false });
